...
class qr_code_dinamico {
    ...
    async gerar_qr_code(payload_json, urlPsp, txid_payload){
        ...
        qrcode += payload.dadosGerais.ID_MERCHANT_ACCOUNT_INFORMATION + this.gerarlength(lenght_account_information)
        ...
        qrcode += payload.dadosGerais.ID_ADDITIONAL_DATA_FIELD_TEMPLATE + this.gerarlength(reference_label)
